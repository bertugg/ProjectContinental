...
namespace StarterAssets
{
	...
	{
		[Header("Player")]
		[Tooltip("Total Hitpoints of Player")]
		public int hp;
		...
		[Tooltip("Virtual Camera Object that will follow")]
		public CinemachineVirtualCamera virtualCamera;

		[Header("Weapon")]
		[Tooltip("Weapon position to be held")]
		public Transform WeaponLocation;
		[Tooltip("Current weapon that character holds right now")]
		...
		private void Awake()
		{
			...
			_game.player = this;
			_game.inputs = GetComponent<StarterAssetsInputs>();
		...
		public void EquipStartingWeapon()
		{
			...
			weapon.GetComponent<Gun>().PickUp(WeaponLocation);
			EquipedWeapon = weapon.GetComponent<Gun>();
		}
		...
		private void Move()
		{
			...
			// Add SideStep Camera Rotation Effect
			if(virtualCamera)
				virtualCamera.m_Lens.Dutch = Mathf.Clamp(-transform.InverseTransformDirection(_controller.velocity).x * .25f, -3f, 3f);
		}
